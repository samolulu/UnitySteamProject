...
namespace GapperGames
{
    ...
    public class FogRenderer : ScriptableRendererFeature
    {
        ...
        [SerializeField] private Shader m_FogShader;
        [SerializeField] private Shader m_FogShader_Upscale;
        ...
        public override void AddRenderPasses(ScriptableRenderer renderer, ref RenderingData renderingData)
        {
            ...
            if (rendererMaterial == null)
            {
                if(m_FogShader == null)
                {
                    //Debug.LogError("Missing Fog Shader");
                    return;
                }
                rendererMaterial = new Material(m_FogShader);
            }
            if (upscaleMaterial == null)
            {
                if(m_FogShader_Upscale == null)
                {
                    //Debug.LogError("Missing Fog Upscale Shader");
                    return;
                }
                upscaleMaterial = new Material(m_FogShader_Upscale);
            }
