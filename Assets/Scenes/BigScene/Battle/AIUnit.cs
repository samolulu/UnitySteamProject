...
public class AIUnit : Unit
{
    ...
    protected override void UpdateCombatState()
    {
        ...
        // 否则向目标移动
        else if (distanceToTarget > attackRange*2f || distanceToTarget > attackRange*0.8f &&  attackTimer >= attackCooldown)  // 稍微靠近一点再攻击
        {
        ...
        else
        {
            ...
            SetDestination(transform.position + awayDirection * attackRange * 0.5f);
            MoveToDestination();
        }
    }
