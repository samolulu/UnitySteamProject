...
public class NPCFollow : MonoBehaviour
{
    ...
    // 新增：渲染状态与驱动模式
    private bool isVisible = true;        // 是否在镜头内
    private bool useRootMotion = true;    // 是否使用Root Motion
    ...
    private bool isTooFar = false;        // 是否超过距离阈值
	...
	public void SetChasingStart(Vector3 position)
	{
		isChasing = true;
		startDelayTimer = 0;
		SetTargetPosition(position);
	}
	public void SetChasingEnd()
	{
		isChasing = false;
		GenRandomDelayTime();
	}
    ...
    private void SwitchToTransformMove()
    {
        ...
        invisibleMoveSpeed = animator != null ? animator.GetFloat("Speed") : 0;
    ...
    void Update()
    {
        ...
        if (!isPlayerMoving && !isMoving && !isChasing) return;
